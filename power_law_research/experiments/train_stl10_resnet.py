...
if __name__ == "__main__":
    ...
    for trial in trials:
        for i, gamma in enumerate(gammas):
            ...
            log_dir_base = f"../log/stl10/clamp100/trial={trial}/gamma={gamma}"
            ...
            data_module = STL10DataModule(num_workers=8, data_dir="../data")
            data_module.train_transforms = None  # Hack
            data_module.val_transforms = None
